            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full px-8 py-4 font-bold rounded-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed text-white"
                  style={{
                ...
                {submitStatus === 'success' && (
                  ...
                  >
                    Message sent successfully! I\u2019ll get back to you soon.                  </motion.p>
                )}
